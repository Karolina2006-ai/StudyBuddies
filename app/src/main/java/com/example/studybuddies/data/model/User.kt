...
data class User(
    ...
    // Personal details. Note: fullName is stored directly to save CPU time on the phone.
    ...
    // Stores how many 1-star, 2-star, etc., reviews a user has.
    ...
    // Mapping days (e.g., "Monday") to a list of available hours (e.g., ["10:00", "14:00"]).
    ...
    /**
     * Logic to generate initials like "JD" for "John Doe".
    ...
    // Quick check used throughout the UI to hide/show Tutor-specific buttons.

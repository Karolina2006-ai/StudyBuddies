...
data class Tutor(
    ...
    // Basic identity info. Keeping it consistent with the general 'User' model (so it will be all sync)
    var firstName: String = "",
    var surname: String = "",

    var city: String = "",
    var university: String = "",
    var bio: String = "", // A short description about the tutor
    ...
    // Pricing info. Using Double allows for cents (example 24.50), though usually it will be probably a whole numbers.
